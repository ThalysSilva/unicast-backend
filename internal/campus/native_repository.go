...
func (r *nativeRepository) Create(campus *Campus) error {
	query := `
...
func (r *nativeRepository) FindByID(id string) (*Campus, error) {
	query := `
...
// Atualiza um campus
func (r *nativeRepository) Update(campus *Campus) error {
	query := `
        UPDATE campuses
