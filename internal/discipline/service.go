...
type Service interface {
	...
	GetDisciplinesByProgramID(ctx context.Context, programID string) ([]*Discipline, error)
...
func NewService(disciplineRepository Repository) Service {
	return &disciplineService{disciplineRepository: disciplineRepository}
}

func (s *disciplineService) Create(ctx context.Context, programID, name, description string, year, semester int) error {
...
func (s *disciplineService) GetDisciplinesByProgramID(ctx context.Context, programID string) ([]*Discipline, error) {
